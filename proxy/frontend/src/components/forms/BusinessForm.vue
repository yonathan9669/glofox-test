<template>
  <v-form @submit.prevent="submit">
    <v-autocomplete
      ...
      :items="businesses"
      :loading="isLoading"
      :search-input.sync="queryBusiness"
      chips
      hide-details
      hide-selected
      item-text="name"
      ...
      solo
      @keydown.enter="processBusiness(queryBusiness)"
      @blur="queryBusiness = null"
      :disabled="isNew"
    >
